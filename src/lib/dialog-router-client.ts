...
export class DialogRouterClient {
  ...
  async ensureLogin(): Promise<void> {
    ...
    const encodedUser = Buffer.from(this.profile.routerUsername).toString("base64");
    const encodedPass = Buffer.from(this.profile.routerPassword).toString("base64");
